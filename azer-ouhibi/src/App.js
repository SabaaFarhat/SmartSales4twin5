...
import reset2 from './page/reset2';
...
const AllUsers = loadable(() => pMinDelay (import ('./page/vendor/all-user'), 250), { fallback: <Loading />});
...
const Reset = loadable(() => pMinDelay(import ('./page/reset'), 250), { fallback: <Loading />});
const Reset2 = loadable(() => pMinDelay(import ('./page/reset2'), 250), { fallback: <Loading />});
      ...
      <BrowserRouter>
        <Router>
          ...
          <Switch>
            ...
            <Route path='/vendor/all-user' exact component={AllUsers} />
            ...
            <Route path='/reset2/:token' exact component={Reset2} />
